    ...
    >
      ...
      >
        <AiOutlineClose
          ...
          onClick={onClose}
        />
        <h2 className="w-fit px-4 py-1 bg-indigo-500 rounded-lg text-white">
          {book.publishYear}
        </h2>
        ...
        <p className="mt-4">Thing you need to know.</p>
        <p className="mt-2">"Please read this book with pleasure."</p>
      </div>
    </div>
  );
};
